...
Inspector catches it via the **simulator log / crash report** and **verify-after-act**.
...
xcrun simctl launch booted com.inspector.SampleBuggyApp
```
Driven by `inspector/adapters/ios.py` (task #10). See
